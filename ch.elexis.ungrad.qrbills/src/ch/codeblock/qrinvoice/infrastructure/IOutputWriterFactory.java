...
public interface IOutputWriterFactory extends Service<Object> {
    boolean supports(final PaymentPartReceiptWriterOptions options);

    IPaymentPartReceiptWriter create(final PaymentPartReceiptWriterOptions options);

    boolean supports(final QrCodeWriterOptions options);

    IQrCodeWriter create(final QrCodeWriterOptions options);
