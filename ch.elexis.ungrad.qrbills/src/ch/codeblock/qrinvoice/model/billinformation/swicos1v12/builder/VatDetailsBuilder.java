...
public final class VatDetailsBuilder {
    ...
    public VatDetailsBuilder taxPercentage(double taxPercentage) {
        return taxPercentage(BigDecimal.valueOf(taxPercentage));
    }

    public VatDetailsBuilder taxPercentage(BigDecimal taxPercentage) {
        this.taxPercentage = taxPercentage;
        return this;
    }

    public VatDetailsBuilder taxedNetAmount(double taxedNetAmount) {
        return taxedNetAmount(BigDecimal.valueOf(taxedNetAmount));
    }

    public VatDetailsBuilder taxedNetAmount(BigDecimal taxedNetAmount) {
