...
public class BillInformationParser {
    ...
    public BillInformation parseBillInformation(String billInformation) {
        if (StringUtils.isEmpty(billInformation)) {
            return null;
        }

        final BillInformationTypes[] values = BillInformationTypes.values();
        for (final BillInformationTypes value : values) {
            if (value.getBillInformationType().supports(billInformation)) {
                return value.getBillInformationType().parse(billInformation);
            }
        }
