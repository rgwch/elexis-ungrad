...
public class ValidationException extends BaseException {
    ...
    public static ValidationException fromMessageKey(String msgKey) {
        return new ValidationException(ResourceBundle.getBundle("qrinvoice", Locale.ENGLISH).getString(msgKey));
    }
}
