...
/*******************************************************************************
 * Copyright (c) 2005-2024, G. Weirich and Elexis
...
/**
 * This View is marked deprecated in Elexis core, but I need it. So save it here.
 */
 ...
 *
 */
public class KonsZumVerrechnen extends ViewPart {
	...
	KonsZumVerrechnen self;

	public KonsZumVerrechnen() {
		cv = new CommonViewer();
	...
	public void createPartControl(final Composite parent) {
		...
		cv.getViewerWidget().setComparator(new KonsZumVerrechnenViewerComparator());
		...
		tvSel.setComparator(new KonsZumVerrechnenViewerComparator());
