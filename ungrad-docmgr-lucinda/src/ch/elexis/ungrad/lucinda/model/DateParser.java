...
public class DateParser {
	private static final Map<String, String> DATE_FORMAT_REGEXPS = new HashMap<String, String>() {
		{
			...
			put("^\\d{1,2}\\s[a-z]{4,}\\s\\d{4}\\s\\d{1,2}:\\d{2}:\\d{2}$", //$NON-NLS-1$
				"dd MMMM yyyy HH:mm:ss"); //$NON-NLS-1$
		}
	};
	...
	/**
	 * Parse the given date string to date object and return a date instance based on the given date
	 * string. This makes use of the {@link DateParser#determineDateFormat(String)} to determine the
	 ...
	 *             If the date format pattern of the given date string is unknown, or if the given
	 *             date string or its actual date is invalid based on the date format pattern.
	 */
	 ...
	 * @return The parsed date object.
	 * @throws ParseException
	 *             If the given date string or its actual date is invalid based on the given date
	 *             format pattern.
	 * @see SimpleDateFormat
	 */
