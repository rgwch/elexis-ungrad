...
public class MBox {
	...
	public MBox() {
	        this.path = Paths.get("/home/gerry/.thunderbird/vvdxj3mb.default-release/ImapMail/imap.mail.hin.ch/INBOX");
	        // mbox=new Provider(Provider.Type.STORE, "mbox", "com.sun.mail.mbox.MboxStore", "Oracle", "3.2.1");
