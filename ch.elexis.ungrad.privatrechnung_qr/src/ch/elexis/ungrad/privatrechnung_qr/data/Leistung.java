...
/**
 * A billing plugin that is able to manage several arbitrary tax systems and print QR-Bills
 * We use deliberately a table created by an earlier plugin. So we can continue using the same codes.
 * 
 * @author gerry
 * 
 */
