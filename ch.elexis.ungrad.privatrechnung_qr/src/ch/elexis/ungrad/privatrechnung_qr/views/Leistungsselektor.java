...
import ch.elexis.ungrad.privatrechnung_qr.model.LeistungenLoader;
...
public class Leistungsselektor extends CodeSelectorFactory {
	...
	public ViewerConfigurer createViewerConfigurer(CommonViewer cv){
		...
		ViewerConfigurer vc = new ViewerConfigurer(tdl, new ViewerConfigurer.TreeLabelProvider(),
			new SelectorPanelProvider(new FieldDescriptor<?>[] {
				fdName
			}, true), new ViewerConfigurer.DefaultButtonProvider(),
			new SimpleWidgetProvider(SimpleWidgetProvider.TYPE_TREE, SWT.VIRTUAL, null));
		return vc;
	}
