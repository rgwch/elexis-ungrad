...
public class PreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	public static final String JAR_PATH = "risch/jar_path"; //$NON-NLS-1$
	public static final String INI_PATH = "risch/ini_path"; //$NON-NLS-1$
	public static final String DL_DIR = "risch/downloaddir"; //$NON-NLS-1$
