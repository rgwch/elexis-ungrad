  ...
  <xsl:template match ="invoice:*">
  	...
  	<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" font-family="OCRB10PitchBT-Regular">
  	 <fo:layout-master-set>
  	  <!-- margin-right für Abstand Codierzeile-rechter Papierrand. margin-bottom für Abstand Codierzeile-Papierunterrand. margin-left = globaler Abstand von links für Text und EZ
		    		-->
  	  <fo:simple-page-master master-name="LD2-S" page-height="29.7cm" page-width="21cm" margin-top="{$topMargin}" margin-bottom="{$bottomMargin}" margin-left="{$leftMargin}" margin-right="{$rightMargin}">
       ...
       <!-- ganzer Block mit margin-left=0.5cm eingerückt von links her
		-->
  		 	<fo:table table-layout="fixed" width="100%" margin-left="0.5cm" >
  			   ...
  			   <fo:table-row>
	  		    <fo:table-cell>
	  		    	<fo:block text-align="left"  font-family="tahoma,arial,helvetica,sans-serif" font-size="10px" color="#000000">
	  		    		Dr. med. <xsl:choose>
	  		   ...
	  		   <fo:table-row >
	  		    <fo:table-cell>
	  		    	<fo:block text-align="left"  font-family="tahoma,arial,helvetica,sans-serif" font-size="8px" color="#000000">
	  		    		<xsl:choose>
             				<xsl:when test="count(/invoice:request/invoice:invoice/invoice:tiers_garant) > 0">
             					<xsl:value-of select="/invoice:request/invoice:invoice/invoice:tiers_garant/invoice:biller/invoice:person/invoice:postal/invoice:street" />,<fo:inline> &#160;</fo:inline>
             					CH-<xsl:value-of select="/invoice:request/invoice:invoice/invoice:tiers_garant/invoice:biller/invoice:person/invoice:postal/invoice:zip" /><fo:inline> &#160;</fo:inline>
             				...
             				<xsl:otherwise>
	             				<xsl:value-of select="/invoice:request/invoice:invoice/invoice:tiers_payant/invoice:biller/invoice:person/invoice:postal/invoice:street" />,<fo:inline> &#160;</fo:inline>
	             				CH-<xsl:value-of select="/invoice:request/invoice:invoice/invoice:tiers_payant/invoice:biller/invoice:person/invoice:postal/invoice:zip" /><fo:inline> &#160;</fo:inline>
	  		   ...
	  		   <fo:table-row >
	  		    <fo:table-cell>
	  		    	<fo:block text-align="left"  font-family="tahoma,arial,helvetica,sans-serif" font-size="8px" color="#000000">
	  		    		<xsl:choose>
             				<xsl:when test="count(/invoice:request/invoice:invoice/invoice:tiers_garant) > 0">
             					Tel. <fo:inline> &#160;</fo:inline><xsl:value-of select="/invoice:request/invoice:invoice/invoice:tiers_garant/invoice:biller/invoice:person/invoice:telecom/invoice:phone" />,<fo:inline> &#160;</fo:inline>
             					Fax <fo:inline> &#160;</fo:inline><xsl:value-of select="/invoice:request/invoice:invoice/invoice:tiers_garant/invoice:biller/invoice:person/invoice:telecom/invoice:fax" /> 
             				</xsl:when>
             				<xsl:otherwise>
	             				Tel. <fo:inline> &#160;</fo:inline> <xsl:value-of select="/invoice:request/invoice:invoice/invoice:tiers_payant/invoice:biller/invoice:person/invoice:telecom/invoice:phone" />,<fo:inline> &#160;</fo:inline>
	             				Fax <fo:inline> &#160;</fo:inline> <xsl:value-of select="/invoice:request/invoice:invoice/invoice:tiers_payant/invoice:biller/invoice:person/invoice:telecom/invoice:fax" />  
             				</xsl:otherwise>
             			</xsl:choose>
	  		    	</fo:block>
	  		    </fo:table-cell>
	  		   ...
	  		   <fo:table-row >
	  		    <fo:table-cell>
	  		    	<fo:block text-align="left"  font-family="tahoma,arial,helvetica,sans-serif" font-size="8px" color="#000000">
	  		    		<xsl:choose>
             				<xsl:when test="count(/invoice:request/invoice:invoice/invoice:tiers_garant) > 0">
             					E-Mail <fo:inline> &#160;</fo:inline><xsl:value-of select="/invoice:request/invoice:invoice/invoice:tiers_garant/invoice:biller/invoice:person/invoice:online/invoice:email" />,<fo:inline> &#160;</fo:inline>
             					Web <fo:inline> &#160;</fo:inline><xsl:value-of select="/invoice:request/invoice:invoice/invoice:tiers_garant/invoice:biller/invoice:person/invoice:online/invoice:url" /> 
             				</xsl:when>
             				<xsl:otherwise>
	             				E-Mail <fo:inline> &#160;</fo:inline> <xsl:value-of select="/invoice:request/invoice:invoice/invoice:tiers_payant/invoice:biller/invoice:person/invoice:online/invoice:email" />,<fo:inline> &#160;</fo:inline>
	             				Web <fo:inline> &#160;</fo:inline> <xsl:value-of select="/invoice:request/invoice:invoice/invoice:tiers_payant/invoice:biller/invoice:person/invoice:online/invoice:url" />  
             				</xsl:otherwise>
             			</xsl:choose>
	  		    	</fo:block>
	  		    </fo:table-cell>
	  		   ...
	  		   <fo:table-row >
	  		    <fo:table-cell>
	  		    	<fo:block text-align="left"  font-family="tahoma,arial,helvetica,sans-serif" font-size="8px" color="#000000">
	  		    		<xsl:choose>
             				<xsl:when test="count(/invoice:request/invoice:invoice/invoice:tiers_garant) > 0">
             					GLN: <xsl:value-of select="/invoice:request/invoice:invoice/invoice:tiers_garant/invoice:biller/@ean_party" />,<fo:inline> &#160;</fo:inline>
             					ZSR: <xsl:value-of select="/invoice:request/invoice:invoice/invoice:tiers_garant/invoice:biller/@zsr" />  
             				</xsl:when>
             				<xsl:otherwise>
	             				GLN: <xsl:value-of select="/invoice:request/invoice:invoice/invoice:tiers_payant/invoice:biller/@ean_party" />,<fo:inline> &#160;</fo:inline>
	             				ZSR: <xsl:value-of select="/invoice:request/invoice:invoice/invoice:tiers_payant/invoice:biller/@zsr" />    
             				</xsl:otherwise>
             			</xsl:choose>
             			<xsl:choose>
               				<xsl:when test="count(/invoice:request/invoice:invoice/invoice:detail/invoice:ivg) > 0">
               					 ,<fo:inline> &#160;</fo:inline>NIF: <xsl:value-of select="/invoice:request/invoice:invoice/invoice:detail/invoice:ivg/@nif" />    
						    </xsl:when>
               				<xsl:otherwise>
  	   ...
  	   <fo:static-content flow-name="xsl-region-after">
  	   	 	<fo:block font-family="OCRB10PitchBT-Regular" text-align="right" margin-right="{$besrMarginHorizontal}">
	  		    <xsl:choose>
		    ...
		    <fo:table-body font-size="9px" font-family="tahoma,arial,helvetica,sans-serif">
  		     ...
  		     <fo:table-row>
		    	...
		    	ganzer Block mit margin-left=1.0cm eingerückt von links her linefeed-treatment="preserve" 
		    		-->
                 <fo:block linefeed-treatment="preserve" background-color="#D3D3D3" margin-left="1.0cm" padding-left="2pt">
		    		Für: <xsl:choose>
               				<xsl:when test="count(/invoice:request/invoice:invoice/invoice:tiers_garant) > 0">
               					<xsl:value-of select="/invoice:request/invoice:invoice/invoice:tiers_garant/invoice:patient/invoice:person/invoice:familyname" /> <fo:inline>&#160;</fo:inline> <xsl:value-of select="/invoice:request/invoice:invoice/invoice:tiers_garant/invoice:patient/invoice:person/invoice:givenname"/>
               				</xsl:when>
               				<xsl:otherwise>
               					<xsl:value-of select="/invoice:request/invoice:invoice/invoice:tiers_payant/invoice:patient/invoice:person/invoice:familyname" /> <fo:inline>&#160;</fo:inline> <xsl:value-of select="/invoice:request/invoice:invoice/invoice:tiers_payant/invoice:patient/invoice:person/invoice:givenname"/>
               				</xsl:otherwise>
		    	...
		    	<!-- Adressat für Fenstercouvert
		    		-->
                <fo:block linefeed-treatment="preserve" padding-top="5pt" padding-left="5pt" border-top-width="0.5pt" border-left-width="0.5pt" border-right-width="0.5pt" border-bottom-width="0.5pt" border-left-color="#D3D3D3" border-right-color="#D3D3D3" border-top-color="#D3D3D3" border-bottom-color="#D3D3D3" border-top-style="solid" border-bottom-style="solid"  border-left-style="solid"  border-right-style="solid">
		    		<fo:inline font-style="italic" font-size="8px">
	             		<xsl:choose>
	             			<xsl:when test="count(/invoice:request/invoice:invoice/invoice:tiers_garant) > 0">
	             				...
	             				<xsl:value-of select="/invoice:request/invoice:invoice/invoice:tiers_garant/invoice:biller/invoice:person/invoice:postal/invoice:city" /> 
	             			</xsl:when>
	             			<xsl:otherwise>
	             				<xsl:value-of select="/invoice:request/invoice:invoice/invoice:tiers_payant/invoice:biller/invoice:person/invoice:familyname" />,<fo:inline> &#160;</fo:inline>
	             				<xsl:value-of select="/invoice:request/invoice:invoice/invoice:tiers_payant/invoice:biller/invoice:person/invoice:postal/invoice:street" />, <fo:inline> &#160;</fo:inline>
	             				...
	             				<xsl:value-of select="/invoice:request/invoice:invoice/invoice:tiers_payant/invoice:biller/invoice:person/invoice:postal/invoice:city" />
	             			</xsl:otherwise>
             			</xsl:choose>
		    		</fo:inline>
		    ...
		    <fo:table-body font-size="9px" font-family="tahoma,arial,helvetica,sans-serif">    
  		     ...
  		     <fo:table-row>
	  		  ...
	  		  <fo:table-cell>
  		        ...
  		        <fo:block linefeed-treatment="preserve">
		    		<xsl:value-of select="/invoice:request/invoice:invoice/invoice:balance/@amount_due" /><fo:inline> &#160;</fo:inline>
		    	</fo:block>
		      ...
		      <fo:table-cell>
  		     	...
  		     	<fo:table-row height="0.5cm">
	  		      <fo:table-cell>
		    		  ...
		    		  <xsl:value-of select="substring-before(/invoice:request/invoice:invoice/invoice:balance/@amount_due, '.')" /><fo:inline> &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;</fo:inline>
		    		  <xsl:value-of select="substring-after(/invoice:request/invoice:invoice/invoice:balance/@amount_due, '.')" />
		    	    </fo:block>
			      </fo:table-cell>
			      <fo:table-cell>
