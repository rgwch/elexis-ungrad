      ...
      <fo:page-sequence master-reference="RF_Arzt_40_Code">
        ...
        <fo:static-content flow-name="xsl-region-after">
          <fo:table table-layout="fixed" width="85%"   >
	  	  ...
	  	  <fo:block font-family="OCRB10PitchBT-Regular" text-align="right"  width="11.1cm">
	  		    <xsl:choose>
  			   ...
  			   <fo:table-row>
	  		    <fo:table-cell border="0.5pt solid black">
		  		        ...
		  		        <fo:table-cell>
		  		   	 	...
		  		   	 	<fo:table-cell>
		  		        	<fo:block font-size="8px" font-family="tahoma,arial,helvetica,sans-serif">
	  		    				<xsl:value-of select="substring(/invoice:request/invoice:invoice/@invoice_id,string-length(/invoice:request/invoice:invoice/@invoice_id) - 3)" />
	  		    			</fo:block>
		  		   	 	</fo:table-cell>
		  		   	   </fo:table-row>
